...
namespace Proxyclick.CSharpInterview.Service.Visitors
{
    ...
    {
        Task<IEnumerable<object>> ListVisitors(string companyId, string? email, string? companyName);
    ...
    public class VisitorService : IVisitorService
    {
        ...
        public virtual Task<IEnumerable<object>> ListVisitors(string companyId, string? email, string? companyName)
        {
